...
class _KitchenPageState extends State<KitchenPage>
  ...
  // All available household appliances with their states
  final Map<String, Map<String, dynamic>> allDevices = {
    "Bulb": {"selected": false},
    "Fan": {"selected": false},
    "TV": {"selected": false},
    "Refrigerator": {"selected": false},
    "Oven": {"selected": false},
  };
                  ...
                  leading: Icon(
                    device == "Bulb"
                        ...
                        : (device == "Fan"
                            ? Icons.air // Fan Icon
                            : Icons
                                .device_unknown), // Default for other devices
                    color: device == "Bulb" && deviceData['selected']
                        ? Colors.yellow
                        : Colors.white,
                    size: 28,
                  ),
                  ...
                  Card(
                    ...
                    child: ListTile(
                      leading: device == "Fan"
                          ? AnimatedBuilder(
                              ...
                              builder: (context, child) {
                                return Transform.rotate(
                                  angle: selectedDevices[device] > 0
                                      ? _fanController.value * 2 * 3.1416
                                      : 0,
                                  child: Icon(
                                    Icons.air,
                                    color: Colors.white,
                          ...
                          : Icon(
                              Icons.lightbulb,
                              color: device == "Bulb" && selectedDevices[device]
                                  ? Colors.yellow
                                  : Colors.grey,
                              size: 28,
                            ),
